...
### This is the source code for a simple C# game engine used to make 2D tile mapped games for Windows from scratch in Visual Studio. Uses MonoGame libraries for rendering pipeline and FMOD for sound.
> [!WARNING]
